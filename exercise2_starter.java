...
public class Exercise17_02 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try(DataOutputStream output = new DataOutputStream
            ...
            int[] nums = {1,6,7,836,23,150,42,95,21};
            ...
            output.writeDouble(currentTime.getTime());
        ...
        try (DataInputStream input = new DataInputStream(new FileInputStream("Exercise17_02.dat"))){
            ...
            int[] readNums = {input.readInt(),input.readInt(),input.readInt(),input.readInt(),input.readInt()};
            ...
            double dubDate = input.readDouble();
            ...
            System.out.println(" Double Date: " + dubDate);
